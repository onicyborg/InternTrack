...
class AttendanceDosenController extends Controller
{
    /**
     * Tampilkan daftar mahasiswa binaan untuk kelola/verifikasi absensi.
     */
    public function index()
    {
        ...
        // Hitung absensi pending per mahasiswa (menunggu approval dosen)
    ...
    /**
     * Detail attendance untuk 1 mahasiswa binaan.
     */
    public function show(string $id)
    {
        ...
        // Pastikan mahasiswa tsb adalah binaan dosen yang login
        ...
        return view('dosen.attendance_detail', [
            'student' => $student,
            'rows' => $rows,
    ...
    public function approve(Request $request, string $attendanceId)
    {
        ...
        // Pastikan absensi milik mahasiswa binaan dosen yang login
