			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-lg-row-fluid">
					...
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						...
						<!--end::Image-->
						<!--begin::Title-->
						<h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">InternTrack Portal</h1>
						<!--end::Title-->
						<!--begin::Text-->
						<div class="text-gray-600 fs-base text-center fw-semibold">Kelola proses magang dengan mudah.
						<br />Pantau kehadiran, logbook, dan progres secara terpusat
						<br />untuk perusahaan, pembina, dosen, dan mahasiswa.</div>
						<!--end::Text-->
					</div>
					<!--end::Content-->
				</div>
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="{{ url('login') }}">
									...
									<div class="text-center mb-11">
										...
										<!--end::Title-->
										<!--begin::Subtitle-->
										<div class="text-gray-500 fw-semibold fs-6">Portal InternTrack</div>
										<!--end::Subtitle=-->
									</div>
									<!--begin::Heading-->
									<!--begin::Input group=-->
