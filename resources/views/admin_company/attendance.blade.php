...
@section('title', 'Admin - Attendance Mahasiswa')
@section('page_heading', 'Attendance Mahasiswa')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('company_admin.attendance.show', $mhs->id) }}" class="btn btn-sm btn-action btn-primary">
                                            Lihat Data
                                        </a>
                                    </div>
                                </td>
        ...
        (function(){
            ...
            if (window.jQuery && $.fn && $.fn.DataTable) {
                ...
                searchInput.addEventListener('input', function(){
                    ...
                    rows().forEach(tr => { tr.style.display = normalize(tr.innerText).includes(q) ? '' : 'none'; });
                });
            }
        })();
    </script>
