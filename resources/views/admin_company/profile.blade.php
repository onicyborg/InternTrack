            ...
            <div class="card-body">
                <form id="profileForm">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" class="form-control" id="full_name" name="full_name" value="{{ optional(optional($user)->profile)->full_name ?? '' }}" placeholder="Nama lengkap">
                        <div class="invalid-feedback" data-field="full_name"></div>
                    </div>
                    <div class="mb-6">
                        <label class="form-label">Telepon</label>
                        <input type="text" class="form-control" id="phone" name="phone" value="{{ optional(optional($user)->profile)->phone ?? '' }}" placeholder="Nomor telepon">
...
<script>
    ...
    const routes = {
        updateProfile: '{{ route('company_admin.profile.update') }}',
        updatePhoto: '{{ route('company_admin.profile.photo') }}',
        changePassword: '{{ route('company_admin.profile.change_password') }}',
    };
    ...
    passwordForm?.addEventListener('submit', function(e){
        ...
        fetch(routes.changePassword, {
            ...
            Object.keys(errs).forEach(field => {
                ...
                input && input.classList.add('is-invalid');
                const fb = passwordForm.querySelector(`.invalid-feedback[data-field="${field}"]`);
                fb && (fb.textContent = errs[field][0]);
            });
