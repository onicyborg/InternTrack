...
@section('title', 'Admin - Logbook Mahasiswa')
@section('page_heading', 'Logbook Mahasiswa')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('company_admin.logbooks.show', $mhs->id) }}" class="btn btn-sm btn-action btn-primary">
                                            Lihat Logbook
                                        </a>
                                    </div>
                                </td>
